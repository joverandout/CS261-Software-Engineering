...
# load classifier 
classifier = TextClassifier.load('best-model-adam.pt')
...
# offEval = Offensive('You dress like a champ. I was bored the whole time. I can see you put a lot of effort into this.')
